   ...
   */
   function newsmatic_top_border_color( $selector, $control, $property = 'border-color' ) {
      ...
      if( isset( $decoded_control['type'] ) ) :
         ...
         if($type == 'solid'){
            if( isset( $decoded_control[$type] ) ) echo $selector . "{ border-color: ". newsmatic_get_color_format( $decoded_control[$type] ) .";}";
            if( isset( $decoded_control[$type] ) ) echo $selector . " li{ border-color: ". newsmatic_get_color_format( $decoded_control[$type] ) .";}";
         }
         if($type == 'gradient'){
